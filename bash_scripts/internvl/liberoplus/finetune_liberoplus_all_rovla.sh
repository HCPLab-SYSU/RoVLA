...
torchrun --nproc_per_node=$NUM_GPUS --standalone \
    ...
    --dataset_path /vla/users/luojingzhou/data/datasets/libero_plus_lerobot_4suite/lerobot \
    --embodiment_tag LIBEROPLUS_PANDA \
    --num_gpus $NUM_GPUS \
    --output_dir /vla/users/luojingzhou/data/checkpoints/GR00TN-1.6-InterVL3.5-3B/liberoplus/rovla \
    --save_steps 5000 \
    --save_total_limit 5 \
    --max_steps 60000 \
    --warmup_ratio 0.05 \
