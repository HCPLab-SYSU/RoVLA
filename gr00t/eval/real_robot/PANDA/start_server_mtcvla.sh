...
./.venv/bin/python gr00t/eval/run_gr00t_server.py \
    --model-path /data0/luojingzhou/data/checkpoints/GR00T-N1.6-InternVL3.5-3B-checkpoints/hcp_panda_0315/hcp_panda_all_6w_pgd_step3_wonoiseadv_epsilon0d03_cslearning_tasklist/checkpoint-60000 \
